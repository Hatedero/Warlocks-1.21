package net.hatedero.warlocksmod.entity.black_hole;
...
public class BlackHoleRenderer extends EntityRenderer<BlackHole> {
    ...
    private static final ResourceLocation CENTER_TEXTURE = ResourceLocation.fromNamespaceAndPath(WarlocksMod.MOD_ID, "textures/entity/black_hole/black_hole.png");
    private static final ResourceLocation BEAM_TEXTURE = ResourceLocation.fromNamespaceAndPath(WarlocksMod.MOD_ID, "textures/entity/black_hole/beam.png");
