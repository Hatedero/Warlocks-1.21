package net.hatedero.warlocksmod.capability.abilities.chargeable;
...
public class PlayerChargeable implements IThunderSnap, INBTSerializable<CompoundTag> {
    int power = 0;
